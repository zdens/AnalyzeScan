...
<xsl:stylesheet version="2.0" 
                ...
                xmlns:cff="http://sashimi.sourceforge.net/schema_revision/mzXML_2.1" 
  ...
  <!--<xsl:import-schema schema-location="file:///C:/Users/den/source/repos/AnalyzeScan/LIMPFileReader/xsd/mzXML__idx_2.1.xsd" use-when="system-property('xsl:is-schema-aware')='yes'" namespace="http://sashimi.sourceforge.net/schema_revision/mzXML_2.1"/>-->
